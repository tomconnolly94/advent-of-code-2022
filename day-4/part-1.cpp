...
bool range_1_contains_range_2(int range_1_lower, int range_1_upper, int range_2_lower, int range_2_upper)
{
...
int main()
{
    ...
    for(auto inputLine : *inputLines)
    {
        ...
        if(regex_search(inputLine, matches, rgx)) {
            ...
            if(range_1_contains_range_2(elf1Start, elf1End, elf2Start, elf2End) || 
                range_1_contains_range_2(elf2Start, elf2End, elf1Start, elf1End))
